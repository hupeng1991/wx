...
public class Page {
	...
	public String getPageStr() {
		...
		if(totalResult>0){
			sb.append("	<ul>\n");
			if(currentPage==1){
				sb.append("	<li><a>共<font color=red>"+totalResult+"</font>条记录</a></li>\n");
				sb.append("	<li><a>首页</a></li>\n");
				sb.append("	<li><a>&#8249;</a></li>\n");
			}else{
				sb.append("	<li><a>共<font color=red>"+totalResult+"</font>条记录</a></li>\n");
				sb.append("	<li style=\"cursor:pointer;\"><a onclick=\"nextPage(1)\">&#8249;&#8249;</a></li>\n");
				sb.append("	<li style=\"cursor:pointer;\"><a onclick=\"nextPage("+(currentPage-1)+")\">&#8250;</a></li>\n");
			}
			...
			if(currentPage==totalPage){
				...
				sb.append("	<li style=\"cursor:pointer;\"><a onclick=\"nextPage("+(currentPage+1)+")\">&#8250;</a></li>\n");
				sb.append("	<li style=\"cursor:pointer;\"><a onclick=\"nextPage("+totalPage+")\">&#8250;&#8250;</a></li>\n");
			}
